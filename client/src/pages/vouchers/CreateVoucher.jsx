...
import { apiCreateVouchers } from "../../apis/voucher";
...
const CreateVoucher = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiCreateVouchers(formData);
    ...
    <Container className="m-5">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Grid2 container fullWidth spacing={2} sx={{ mt: 2 }}>
          ...
          <Grid2 size={6}>
            <FormControl fullWidth margin="dense" variant="standard">
              <InputLabel htmlFor="voucherDiscountType">
                {t("discount-type")}
              </InputLabel>
              <Input
          ...
          <Grid2 size={6}>
            <FormControl fullWidth margin="dense" variant="standard">
              <InputLabel htmlFor="voucherDiscountValue">
                {t("discount-value")}
              </InputLabel>
              <Input
