...
function Row(props) {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            icon: "warning",
            title: "Bạn có chắc muốn xóa phiếu giảm này, thao tác sẽ không thể hoàn trả",
...
const VoucherTable = ({ searchTerm }) => {
    ...
    useEffect(() => {
        const fetchVouchers = async () => {
            const response = await apiGetVouchers(currentPage, rowsPerPage, searchTerm);
                ...
                <Table aria-label="collapsible table" className="border">
                    ...
                    <TableBody>
                        {Array.isArray(vouchers) && vouchers.length > 0 ? (
                            ...
                            <TableRow>
                                <TableCell colSpan={10} align="center">No vouchers found</TableCell>
                            </TableRow>
                        )}
                    </TableBody>
                </Table>
